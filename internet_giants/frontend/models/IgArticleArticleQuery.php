...
/**
 * IgArticleArticleQuery represents the model behind the search form of `app\models\IgArticleArticle`.
 */
class IgArticleArticleQuery extends IgArticleArticle
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['art_id', 'us_id', 'art_title', 'art_content', 'art_rev_date'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'art_like' => $this->art_like,
            'art_com_num' => $this->art_com_num,
            'art_rev_date' => $this->art_rev_date,
        ]);

        $query->andFilterWhere(['like', 'art_id', $this->art_id])
