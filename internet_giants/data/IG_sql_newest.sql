...
alter table IG_Article_Viparticle add constraint FK_IG_Article_Herit foreign key (art_id)
      references IG_Article_Article (art_id) on delete restrict on update restrict;

alter table IG_User_Message add constraint FK_IG_User_LMess foreign key (us_id)
      references IG_User_User (us_id) on delete restrict on update restrict;
...
alter table IG_User_Vipuser add constraint FK_IG_User_Herit foreign key (us_id)
      references IG_User_User (us_id) on delete restrict on update restrict;
